...
ROBOT_PERSONAL_SPACE_TRIGGER_METERS = 0.5
ROBOT_PERSONAL_SPACE_RELEASE_METERS = 0.6
ROBOT_PERSONAL_SPACE_BACKOFF_SPEED_METERS = 0.5
ROBOT_FOOTPRINT_RADIUS_METERS = 0.20
ROBOT_PERSONAL_SPACE_MAX_RETREAT_DISTANCE_METERS = 0.6
ROBOT_PERSONAL_SPACE_PROBE_DISTANCE_METERS = 0.2
